...
<p align="center">
  ...
  <em>Qwen3.5-2B VLM (image+text, hybrid SSM + self-built vision tower, ctx512) streaming natively on the RDK S100P BPU, bilingual — the English follow-up counts the remotes correctly without the image being re-attached</em>
</p>
